...
namespace NoteAppUI
{
    partial class AboutForm
    {
        ...
        private void InitializeComponent()
        {
			...
			this.label3.Text = "Author: Polina Girn";
			...
			this.label6.Text = "2022 Polina Girn ©";
			// 
			// linkLabel1
			// 
			...
			this.linkLabel1.Text = "lina000805@gmail.com";
			// 
			// linkLabel2
			// 
			...
			this.linkLabel2.Text = "https://github.com/PolinaGirn/NoteApp";
			// 
			// AboutForm
			// 
